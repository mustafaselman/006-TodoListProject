...
// const form = document.querySelector("#todo-form"); const todoInput =
// document.querySelector("#todo"); const todoList =
...
function addTodo(e)
{
    ...
    if (newTodo === "")
    {
        showAlert("danger", "Please enter a newTodo");
    } else
    {
        addTodoToUI(newTodo);
        addTodoToStorage(newTodo);
        showAlert("success", "Added new Todo to UI");
    }
